...
An fully abstracted value may only be used
...
What more, Houyhnhnms understand that when building software components and applications,
...
Humans try to identify an artifact to sell rather;
...
and I saw that I needed to escape that context and its metaphors
if I wanted to better understand Houyhnhnm computing, for which they did not apply.
