...
they have unboxed extensions to a common platform that handles all the communication.
...
rather than at some random application.
...
Better software quality for lower quantity of development efforts expanded.
