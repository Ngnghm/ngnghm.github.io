...
any of the actually difficult issues with ownership and soreignty;
...
is completely different from a Human language, and that there is not exact one-to-one correspondance
