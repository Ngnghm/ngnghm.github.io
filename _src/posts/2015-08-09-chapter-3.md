...
Houyhnhnms computing systems may be more robust than Human computer systems,
...
More generally, a Houyhnhnm can use virtualization and rollback to do any kinds of experiments,
so he never has to hesitate about doing anything
risky, half-baked, downright stupid, or otherwise dangerous.
But virtualization isn't the same thing in a Houyhnhnm computing system as in a Human computer system.
In a Human computer system, virtualization is an _ad hoc_ tool for system administrators
allowing the deployment of specially prepared servers by faking a computer
...
that consists in going down to that level).
...
some of them may have to be accepted as losses or errors (you can't unprint a pile of garbage).
In the end, even Houyhnhnm computing systems can't protect you from yourself;
...
and of course to merge two branches back together, somehow fusing changes.
