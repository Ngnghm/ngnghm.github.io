...
so he never has to hesitate about doing something risky, half-baked, stupid, or otherwise dangerous.
...
allowing the deployment of specially prepared servers.
...
and ultimately cannot be separated from the rest of the design.
On this topic like others, from the necessity of dealing with the same basic needs and failure scenarios,
the change in _point of view_ leads to very different approaches to keeping the systems robust.
