...
What more, to Houyhnhnms, change to programs is what programming verily _is_:
...
the modifying, branching and merging of objects
also apply to these histories of code and data changes.
