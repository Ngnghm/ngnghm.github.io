...
of data exchanged by their communication protocols,
...
At the extreme end opposite implicit communication,
...
they are wholly unnecessary in a computer system;
a computer system is happy with just 0's and 1's, and
any name beside memory addresses and offsets
...
where the activities of programmers requires abstraction and communication
...
are generally the task of a series of (meta)programs separate
from the ones that are computing the results.
