    ...
    Tags: DRAFT, Meta, Application, Autistic, Platform, Extension, Language, Expertise, Economics, Incentives, Division of Labour, Specialization
...
Because of the high barrier to communication between applications,
Human applications grow into big hulking pieces of software
...
Houyhnhnms will instead use their common platform to configure and extend all software.
...
almost never well, by developers who are seldom specialists in those tasks.
...
of a feature they are mediocre at for yet another application.
...
As a result, most successful application platforms start as some amateur's
...
selling their services to those who require improvement for their applications.
Experts don't need to restart their work from scratch for every application,
but need only do it once per platform.
There are only a few worthwhile platforms, and
...
is much lower in Houyhnhnm systems than in Human systems,
while the average domain expertise of those who implement each feature is much higher.
Better software quality for lower quantity of development efforts.
